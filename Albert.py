...
model = AlbertForSequenceClassification.from_pretrained("ALINEAR/albert-japanese-v2")

class MyNet(nn.Module):
    def __init__(self):
        super().__init__()
        self.bert_0 = AlbertForSequenceClassification.from_pretrained(MODEL_NAME, num_labels=150).to(device)
...
dataloader_train = DataLoader(
    dataset_train, batch_size=110, shuffle=True
) 
